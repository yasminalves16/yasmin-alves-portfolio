...
export const experience: ExperienceEntry[] = [
  {
    ...
    focus: 'gestao',
    headline: 'Liderar com código e agilidade.',
    summary:
      'Desenvolvo aplicações em React e TypeScript enquanto facilito o time como Scrum Master — conectando entregas técnicas com as necessidades do negócio.',
    bullets: [
  ...
  },
  {
    ...
    headline: 'Construir interfaces do zero.',
    summary:
      'Comecei minha jornada desenvolvendo interfaces responsivas, criando componentes reutilizáveis e integrando APIs REST em projetos web.',
    bullets: [
  ...
  },
  {
    ...
    role: 'Monitora - IA Generativa, ChatBot e IoT',
    period: 'set 2024 - jan 2025',
    location: 'Remoto',
    focus: 'mentoria',
    headline: 'Ensinar o futuro da IA.',
    summary:
      'Apoiei alunos em turmas de IA Generativa com Google Cloud, Desenvolvimento de ChatBot e IoT — tirando dúvidas sobre Google Cloud Platform, Vertex AI e conduzindo discussões técnicas.',
    bullets: [
      'Suporte técnico aos alunos em aulas de Inteligência Artificial Generativa',
      'Apoio em turmas de Desenvolvimento de ChatBot e IoT',
    ...
    tags: ['Google Cloud', 'Vertex AI', 'Python', 'IA Generativa', 'ChatBot', 'IoT']
  },
  {
    id: 'kenzie-monitora',
