...
export const mediaRecognition: MediaRecognition[] = [
  {
    ...
    title:
      'Uma em cada quatro mulheres inscritas no Qualifica SP busca por cursos profissionalizantes na área de Tecnologia da Informação',
    description:
      'Destaque em matéria oficial do Governo de São Paulo sobre mulheres na tecnologia, com entrevista sobre minha trajetória profissional e a importância da qualificação profissional.',
