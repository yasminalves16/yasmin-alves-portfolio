...
export const mediaRecognition: MediaRecognition[] = [
  {
    ...
    title:
      'One in four women enrolled in Qualifica SP seeks professional courses in Information Technology',
    description:
      'Featured in an official São Paulo Government article about women in technology, with an interview about my career path and the importance of professional qualification.',
